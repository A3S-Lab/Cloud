...
<p align="center">
  ...
  <a href="openapi/v1.json"><img alt="REST contract 1.45.0" src="https://img.shields.io/badge/REST_contract-1.45.0-2872b8" /></a>
...
- **Implemented / stable management contract** — committed
  [OpenAPI `1.45.0`](openapi/v1.json), maintained
  ...
  budgets. Broader enterprise `C0` gates remain.
