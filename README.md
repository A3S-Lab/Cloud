...
<p align="center">
  ...
  <a href="openapi/v1.json"><img alt="REST contract 1.35.0" src="https://img.shields.io/badge/REST_contract-1.35.0-2872b8" /></a>
...
| Connectors | Exact-revision profiles, canonical A3S ACL admission, authorized just-in-time Secret materialization, single-attempt execution, public-Internet DNS/SSRF enforcement with exact address pinning, and immutable bounded terminal evidence | Durable attempt reservation/fencing, internal execution authorization/recovery, provider wiring, supported management surfaces, Workflow ports, and `AUT0.5` availability remain |
...
durable Connector attempt reservation/fencing, internal execution
authorization/recovery, provider wiring, supported management surfaces,
Workflow ports, and the shared Outbox/Event consumer remain gated.
