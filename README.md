...
<p align="center">
  ...
  <a href="openapi/v1.json"><img alt="REST contract 1.7.0" src="https://img.shields.io/badge/REST_contract-1.7.0-2872b8" /></a>
...
| Managed traffic | Domains, certificates, logical Gateway scopes, complete snapshots, routing, health, update, rollback, and exact applied state | Edge, Gateway, Secrets, `E0`, `H0`, `MCP0`, `I0` |
