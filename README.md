...
| Automations | **Component foundation in progress.** Exact-revision webhook admission and schedule calendar, misfire, concurrency, durable cursor/lease, and deterministic due-time invocation-envelope components are implemented. Atomic schedule admission, scheduler/target wiring, live recovery evidence, and public availability remain open |
