...
<p align="center">
  ...
  <a href="openapi/v1.json"><img alt="REST contract 1.50.0" src="https://img.shields.io/badge/REST_contract-1.50.0-2872b8" /></a>
...
- **Implemented / stable management contract** — committed
  [OpenAPI `1.50.0`](openapi/v1.json), maintained
  ...
  healthy facts through that same lifecycle and delivery path. Broader
