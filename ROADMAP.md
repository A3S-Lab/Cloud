...
| `AUT0.3` | In progress; component-only calendar/misfire/concurrency boundaries | Timezone-aware schedules, catch-up rules, lease-safe due evaluation, and P0 scheduled Task adaptation through the existing Boot task rail remain the full gate |
