...
| `AUT0.3` | In progress; component-only calendar boundary | Timezone-aware schedules, catch-up/misfire/concurrency rules, lease-safe due evaluation, and P0 scheduled Task adaptation through the existing Boot task rail remain the full gate |
