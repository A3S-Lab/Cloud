...
| `AUT0.2` | In progress; component-only admission boundary | Signed webhook endpoints, bounded capture, schema validation, exact target, replay, disable/revoke, and Gateway recovery remain the full gate |
