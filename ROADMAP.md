...
composite claim false. The forty-two accepted authority decisions live under
...
| `APP0.2` | In progress; unavailable | Complete application-scoped credential and public delivery admission, remaining message variants, file references/citations, feedback, annotations, blocking/streaming answer parity, repeated-frame Answer ordinals, and retained delivery recovery evidence over C1-C12 |
