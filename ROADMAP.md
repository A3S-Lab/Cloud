...
| `MCP0.3` | Cloud | Foundation in progress | Closed contract values, canonical immutable Service-profile ACL admission, migration 052 plus typed A3S ORM release binding, ordinary Runtime Service-spec projection, and deterministic Gateway ACL compilation exist; route-policy and WorkloadRevision binding, reconciliation, lifecycle surfaces, recovery, audit, and the real PostgreSQL gate remain |
