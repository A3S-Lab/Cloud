...
`C0.3-N5e`; tenant-scoped security investigation, audit retention/export
policy, and usage-fact attribution remain planned. Therefore `C0.3` is still in
progress rather than fully verified.
