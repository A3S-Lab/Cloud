...
| `MCP0.3` | Cloud | Foundation in progress | Closed contract values, canonical immutable Service-profile and separately mutable Edge route-policy ACL admission, migrations 052/053 plus typed A3S ORM persistence, ordinary Runtime Service-spec projection, and deterministic Gateway ACL compilation exist; WorkloadRevision binding, credential authority resolution, target reconciliation, lifecycle surfaces, recovery, audit, and the real PostgreSQL gate remain |
