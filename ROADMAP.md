...
remain planned. `C0.3-PA2a` implements the audit-attribution prerequisite to
signed export and awaits retained main-CI certification. Therefore `C0.3` is
still in progress rather than fully verified.
