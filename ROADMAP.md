...
- REST major version 1 publishes one unauthenticated raw OpenAPI 3.0.3 snapshot
  ...
  responses, envelopes, and compatibility metadata; current contract `1.68.0`
  ...
  compensation contract, Plan/compiler v12, failure v9, and the three closed
  Agent failure classifications without changing prior response bytes.
...
composition, Artifacts outcome adaptation, and owner lifecycle handoff remain
later slices.
...
retry, or timer state is created; production composition, Artifacts outcome
adaptation, and owner lifecycle handoff remain later slices.
