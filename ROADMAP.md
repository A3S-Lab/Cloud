...
protected task list/detail reads and public claim/release/submission. It does not implement
parent-run cancellation coordination, service/finite-task dispatch,
...
release persistence. Migrations `081` and `095` plus the worker-role coordinator
now close accepted submission and automatic expiry to Flow, including exact
parent-timeout supersession evidence. The public task surface exposes protected
