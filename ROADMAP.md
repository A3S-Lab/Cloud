...
composite claim false. The thirty-one accepted authority decisions live under
...
| `APP0.2` | In progress; unavailable | Complete deterministic preset compilers, PostgreSQL session/invocation persistence, production WorkflowRun composition, message variants, file references/citations, feedback, annotations, public cancellation/replay, blocking/streaming parity, and retained recovery evidence over C1 |
