...
Current finite Execution and Connector steps retain closed, bounded
owning-context evidence correlations in the existing step projection. Exact
child Execution, Operation, and Connector attempt URNs are reconstructed only
from verified Flow history, remain authorization-neutral, and add no
provider-body copy, evidence store, migration, route, or OpenAPI shape.
