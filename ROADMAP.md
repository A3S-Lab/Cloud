...
| `APP0.2` | In progress; unavailable | Complete Workflow runtime dispatch over C7, application-scoped credential and public delivery admission, public close/cancel and replay interfaces, remaining message variants, file references/citations, feedback, annotations, blocking/streaming answer parity, and retained delivery recovery evidence over C1-C8 |
