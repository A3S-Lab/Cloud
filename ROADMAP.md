...
| `AUT0.3` | In progress; component-only calendar/misfire/concurrency/due-window/lease boundaries | Timezone-aware schedules, catch-up rules, durable cursor and lease persistence, and P0 scheduled Task adaptation through the existing Boot task rail remain the full gate |
