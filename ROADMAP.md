...
composite claim false. The thirty-two accepted authority decisions live under
...
| `APP0.2` | In progress; unavailable | Complete deterministic preset compilers, typed production WorkflowRun composition, message variants, file references/citations, feedback, annotations, public cancellation/replay, blocking/streaming parity, and retained recovery evidence over C1/C2 |
