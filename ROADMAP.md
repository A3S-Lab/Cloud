...
1. certify the shared immutable-object contract for distributed production
   ...
   `CELL0.5-C5a` supplies the stopped-current-revision Workloads
   writer-fence receipt and atomic seal enqueue; seal-before-new-writer
   admission, the operator-owned runs, and provider certification remain;
