...
General Notifications SMTP is frozen as `C0.3-N5e` but not implemented;
tenant-scoped security investigation, audit retention/export policy, and
usage-fact attribution also remain planned. Therefore `C0.3` is in progress
