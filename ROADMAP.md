...
- REST major version 1 publishes one unauthenticated raw OpenAPI 3.0.3 snapshot
  ...
  responses, envelopes, and compatibility metadata; current contract `1.65.0`
  ...
  success payload schema, and adds exact Connector revision revocation plus
  closed Connector profile/revision success schemas without changing prior
  response bytes.
