...
for persistent descriptor catalog management, exact semantic-digest pinning
through an explicit next compiler/plan revision, typed variable scopes,
...
10. retain the implemented `W0.1` contracts, backend `W0.2` Ontology lifecycle,
    ...
    protected submission, persistent descriptor management and exact plan
    pinning, typed variable scopes,
