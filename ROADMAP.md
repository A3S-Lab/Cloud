...
start creates no table. Box packaging, distinct database principals/grants,
retained clean-Linux upgrade/rollback/failover evidence, and broader
production installation/HA work remain.
