...
`C0.3-PA2b` now implements the next smallest vertical gate with verification
pending: one bounded, owner/admin-only canonical DSSE export page over that
same redacted query.
