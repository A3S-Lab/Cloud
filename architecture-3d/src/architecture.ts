...
export const ARCHITECTURE_NODES: readonly ArchitectureNode[] = [
  ...
  },
  {
    ...
    status: 'verified',
    gate: 'C0.1',
    summary: 'The maintained client consumes authoritative REST command, query, operation, and log APIs.',
    owns: ['Typed transport', 'Public response models', 'Bounded request handling'],
    boundary: 'The client owns no business rule and cannot bypass tenant or idempotency guards.',
    docsUrl: `${cloudDocs}/packages/cloud-client/README.md`,
  },
  {
    id: 'a3s-box',
    label: 'A3S Box (Local)',
...
const ARCHITECTURE_EDGE_DEFINITIONS = [
  {
    id: 'clients-cloud-client',
    from: 'clients',
    to: 'cloud-client',
    label: 'typed integration',
    journeys: ['deploy', 'source', 'observe'],
  },
  {
    id: 'cloud-client-gateway',
    from: 'cloud-client',
    to: 'gateway',
    label: 'HTTPS /api requests',
    journeys: ['deploy', 'source', 'observe'],
  },
  {
    id: 'code-gateway',
