...
Commands:
  ...
  application-streaming-observation observe APP SESSION INVOCATION [--after-sequence N] Poll streaming invocation observation
  application-asynchronous-observation observe APP SESSION INVOCATION Poll asynchronous invocation observation
  ...
  audit-records export-manifest  Atomically export up to eight signed audit pages and their signed manifest (owner/admin)
  ...
  notification-subscriptions revoke ID Revoke one subscription with optimistic concurrency
  ...
  user-files expire ID    Expire one awaiting UserFile upload reservation
