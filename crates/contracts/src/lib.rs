...
pub use automation::{
    ...
    AutomationMisfireModeV1, AutomationMisfirePolicyV1, AutomationNormalizedEventV1,
    AutomationOutboxEventKindV1, AutomationOutboxMessageV1, AutomationRevision,
    AutomationRevisionSpecV1, AutomationRevisionV1, AutomationScheduleTriggerV1,
    AutomationSubscriptionReferenceV1, AutomationTargetKindV1, AutomationTargetV1,
    AutomationTaskTargetV1, AutomationTriggerPolicyV1, AutomationTriggerV1,
    ...
    AUTOMATION_AUDIT_SCHEMA_V1, AUTOMATION_DEFINITION_MAX_ACL_BYTES,
    AUTOMATION_DEFINITION_SCHEMA_V1, AUTOMATION_INVOCATION_ENVELOPE_MAX_BYTES,
    AUTOMATION_INVOCATION_INLINE_MAX_BYTES, AUTOMATION_INVOCATION_SCHEMA_V1,
    ...
    AUTOMATION_MAX_NAME_BYTES, AUTOMATION_NORMALIZED_EVENT_MAX_BYTES,
    AUTOMATION_NORMALIZED_EVENT_SCHEMA_V1, AUTOMATION_OUTBOX_SCHEMA_V1,
    AUTOMATION_REVISION_SCHEMA_V1, AUTOMATION_WEBHOOK_ENDPOINT_SCHEMA_V1,
    AUTOMATION_WEBHOOK_EVENT_KEY, AUTOMATION_WEBHOOK_MAX_BODY_BYTES,
    AUTOMATION_WEBHOOK_MAX_CAPTURE_BASE64_BYTES, AUTOMATION_WEBHOOK_MAX_CONTENT_TYPE_BYTES,
    AUTOMATION_WEBHOOK_MAX_ENDPOINT_KEY_BYTES, AUTOMATION_WEBHOOK_MAX_SIGNATURE_BYTES,
    AUTOMATION_WEBHOOK_RECEIPT_SCHEMA_V1, AUTOMATION_WEBHOOK_REQUEST_SCHEMA_V1,
};
...
pub use inference::{
    ...
    render_inference_policy_acl_with_routes, render_inference_policy_acl_with_routes_and_workers,
    render_inference_policy_shell_acl, render_inference_route_acl_blocks,
    render_inference_worker_acl_blocks, require_inference_tokenizer_revision,
    require_workers_bound_to_routes, InferenceCredentialAclProjection, InferenceEndpointAcl,
    InferenceGrantAclProjection, InferenceLimitsAclProjection, InferenceModelAclProjection,
    InferenceRouteAclProjection, InferenceServingPhase, InferenceTargetAclProjection,
    InferenceUsageAttemptEvidenceV1, InferenceUsageBatchV1, InferenceUsageCursorV1,
    ...
    InferenceUsageRequestEvidenceV1, InferenceUsageTerminalOutcomeV1, InferenceWorkerAclProjection,
    PowerAdmissionObservation, PowerPromptCacheObservation, PowerTransferHealth,
    PowerWorkerCapabilities, PowerWorkerObservation, INFERENCE_CREDENTIAL_AUDIENCE,
    INFERENCE_TOKENIZER_REVISION_V1, INFERENCE_USAGE_BATCH_SCHEMA_V1,
