...
pub use automation::{
    ...
    AUTOMATION_MAX_NAME_BYTES, AUTOMATION_OUTBOX_SCHEMA_V1, AUTOMATION_REVISION_SCHEMA_V1,
    AUTOMATION_WEBHOOK_ENDPOINT_SCHEMA_V1, AUTOMATION_WEBHOOK_MAX_BODY_BYTES,
