...
const CODE_CORE_SOURCE: &str = "git+https://github.com/A3S-Lab/Code.git?rev=36db7f8bcdf9e04fd8cf77e66e55285b218804c9#36db7f8bcdf9e04fd8cf77e66e55285b218804c9";
...
fn box_provider_gate_uses_the_locked_box_revision() {
    ...
    for package in packages {
        assert_eq!(
            ...
            "{} is not locked to the published Box 3.2.5 release",
            package.name
        );
        assert!(
