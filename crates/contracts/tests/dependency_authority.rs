...
const CODE_CORE_SOURCE: &str = "git+https://github.com/A3S-Lab/Code.git?rev=d9c2050b3ca60c70c1146620d24da82b4907191a#d9c2050b3ca60c70c1146620d24da82b4907191a";
...
fn code_core_uses_the_exact_agent_release_contract_revision() {
    ...
    assert_eq!(packages[0].version, "8.1.0");
