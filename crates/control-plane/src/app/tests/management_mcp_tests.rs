...
async fn management_mcp_hides_and_denies_mutations_without_effective_scope() -> Result<()> {
    ...
    assert_eq!(
        ...
        vec![
            ...
            "a3s_cloud_application_feedbacks_create",
            "a3s_cloud_application_feedbacks_list",
            "a3s_cloud_application_feedbacks_get",
            ...
            "a3s_cloud_partner_subject_links_link",
            ...
            "a3s_cloud_directory_resource_grants_create",
