...
fn cloud_migrations() -> Vec<Migration> {
    vec![
        ...
        Migration::new(
            "178",
            "tenant support grant approvals",
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
        ...
        Migration::new(
            "180",
            "Deployment Runtime execution bindings",
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
        ...
        Migration::new(
            "183",
            "Automation webhook admission persistence",
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
        ...
        Migration::new(
            "186",
            "Automation schedule lease release fence",
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
        ...
        Migration::new(
            "187",
            "Automation invocation admission",
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
        ...
        Migration::new(
            "194",
            "Inference usage request facts and daily rollups",
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
        ...
        Migration::new(
            "195",
            "Inference usage retention authority",
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
        ...
        Migration::new(
            "197",
            "Identity inference credential delivery receipts",
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/../../migrations/197_inference_credential_delivery_receipts.sql"
            )),
        ),
        Migration::new(
            "198",
            "Inference route catalog",
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
...
#[cfg(test)]
#[path = "postgres_tests/automation_schedule_lease_release_migration.rs"]
mod automation_schedule_lease_release_migration_tests;
...
#[cfg(test)]
#[path = "postgres_tests/deployment_runtime_execution_bindings_migration.rs"]
mod deployment_runtime_execution_bindings_migration_tests;
