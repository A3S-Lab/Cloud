...
use crate::modules::applications::domain::{
    AdvanceApplicationInvocationWrite, AppendApplicationMessageWrite,
    ApplicationAsynchronousWaitStatus, ApplicationAudience, ApplicationDeliveryCredential,
...
async fn fixture() -> Fixture {
    ...
    let credential = ApplicationDeliveryCredential::issue(
        ApplicationDeliveryCredentialId::from_uuid(
            Uuid::parse_str("018f0000-0000-7000-8000-000000000050").expect("UUID"),
        ),
        &release,
        "anon-async-key",
...
fn observe_query(fixture: &Fixture) -> ObserveAnonymousApplicationAsynchronousInvocation {
    ObserveAnonymousApplicationAsynchronousInvocation {
...
fn handler(fixture: &Fixture) -> ObserveAnonymousApplicationAsynchronousInvocationHandler {
...
#[tokio::test]
async fn observes_waiting_anonymous_asynchronous_invocation() {
...
#[tokio::test]
async fn observes_succeeded_anonymous_asynchronous_invocation() {
    let fixture = fixture().await;
...
#[tokio::test]
async fn missing_credential_fails_closed_for_anonymous_asynchronous_observation() {
    let fixture = fixture().await;
    let mut query = observe_query(&fixture);
...
#[tokio::test]
async fn foreign_credential_fails_closed_for_anonymous_asynchronous_observation() {
    let fixture = fixture().await;
...
#[tokio::test]
async fn missing_invocation_fails_closed_for_anonymous_asynchronous_observation() {
    let fixture = fixture().await;
    let mut query = observe_query(&fixture);
