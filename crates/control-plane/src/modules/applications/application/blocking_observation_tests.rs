use super::{
    ApplicationAccess, ApplicationAccessScope, ObserveApplicationBlockingInvocation,
...
use crate::modules::applications::domain::{
    ...
    ApplicationBlockingWaitStatus, ApplicationDeliveryPolicy, ApplicationEndUser,
...
use crate::modules::shared_kernel::domain::{
    ApplicationId, ApplicationInvocationId, ApplicationReleaseId,
...
#[tokio::test]
async fn observes_waiting_blocking_invocation() {
    let fixture = fixture().await;
    let observation = ObserveApplicationBlockingInvocationHandler::new(fixture.sessions.clone())
        .execute(
...
#[tokio::test]
async fn observes_succeeded_blocking_invocation() {
    let fixture = fixture().await;
...
#[tokio::test]
async fn unauthorized_project_fails_closed_for_blocking_observation() {
    let fixture = fixture().await;
    let error = ObserveApplicationBlockingInvocationHandler::new(fixture.sessions.clone())
        .execute(
            ObserveApplicationBlockingInvocation {
                organization_id: fixture.session.organization_id,
                project_id: fixture.session.project_id,
...
#[tokio::test]
async fn missing_invocation_fails_closed_for_blocking_observation() {
    let fixture = fixture().await;
    let error = ObserveApplicationBlockingInvocationHandler::new(fixture.sessions.clone())
        .execute(
            ObserveApplicationBlockingInvocation {
