...
mod publication_route_intent_postgres;
mod publication_route_intent_postgres_schema;
...
pub use publication_route_intent_postgres::PostgresApplicationPublicationRouteIntentRepository;
