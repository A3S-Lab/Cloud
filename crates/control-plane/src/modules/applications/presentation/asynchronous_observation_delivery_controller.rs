...
pub fn application_asynchronous_observation_queries_controller(
    ...
    Arc::new(ApplicationAsynchronousObservationQueriesController { bus }).controller()
}

#[derive(Debug, Clone)]
struct ApplicationAsynchronousObservationQueriesController {
    bus: Arc<QueryBus>,
}
...
impl ApplicationAsynchronousObservationQueriesController {
    #[get(
...
#[cfg(test)]
mod nest_macro_asynchronous_observation_controller_tests {
    use super::*;
    use a3s_boot::HttpMethod;

    #[test]
    fn asynchronous_observation_registers_scoped_guarded_get_via_nest_macros() {
        let controller =
            application_asynchronous_observation_queries_controller(Arc::new(QueryBus::new()))
                .expect("asynchronous observation nest controller");
