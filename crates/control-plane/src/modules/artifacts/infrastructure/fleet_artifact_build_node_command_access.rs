...
/// Anti-corruption adapter: Artifacts Build Flow → Fleet Node-command store.
///
/// Translates Artifacts-owned enqueue/reload/ack intents into Fleet
...
impl FleetArtifactBuildNodeCommandAccessAdapter {
...
impl IArtifactBuildNodeCommandPort for FleetArtifactBuildNodeCommandAccessAdapter {
    async fn enqueue_command(
        ...
        let write = self
            ...
            .await?;
        Ok(ArtifactBuildNodeCommandDispatch {
    ...
    async fn find_command(
        ...
        Ok(self
            ...
            .await?
            .map(|command| ArtifactBuildNodeCommandProjection {
                id: command.id,
    ...
    async fn command_acknowledgement(
        ...
        Ok(self
            ...
            .await?
            .map(|acknowledgement| ArtifactBuildNodeCommandAcknowledgement {
