...
pub use domain::{
    ...
    BuildInputPreparationError, BuildOutputValidationError, BuildRun, BuildRunStatus, BuildSource,
    BuildSourceLocation, BuildSourceResolutionError, BuildSubject, DsseEnvelope, DsseSignature,
    IBuildArtifactPublisher, IBuildEvidenceGenerator, IBuildEvidenceSigner, IBuildInputPreparer,
    IBuildOutputValidator, IBuildRunRepository, IBuildSourceResolver, InTotoSubject, OciDescriptor,
    OciPublicationRequest, OciPublicationTarget, PreparedBuildInput, PublishedOciArtifact,
    RequestBuildRetryBundle, SlsaBuildDefinition, SlsaBuilder, SlsaExternalParameters,
    ...
    VerifiedBuildEvidenceSignature, BUILD_EVIDENCE_SCHEMA, DSSE_PAYLOAD_TYPE,
