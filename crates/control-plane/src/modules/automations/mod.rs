...
pub use application::{
    ...
    AutomationInvocationAdmissionService, AutomationScheduleCandidate,
    AutomationScheduleDispatchRequest, AutomationScheduleDispatchResult,
    AutomationScheduleDispatchService, AutomationScheduleWorker, AutomationScheduleWorkerConfig,
    AutomationScheduleWorkerReport, AutomationWebhookAdmissionService,
    AutomationWebhookEndpointQueryService, AutomationWebhookEndpointScope,
    AutomationWebhookReceiver, AutomationsDispatchServices, ChangeAutomationWebhookEndpoint,
...
pub use domain::{
    ...
    AutomationDefinitionRecord, AutomationEventInvocationFactory, AutomationEventInvocationRequest,
...
pub use infrastructure::{
    ...
    InMemoryAutomationDefinitionRepository, InMemoryAutomationInvocationRepository,
    InMemoryAutomationScheduleStateRepository, InMemoryAutomationWebhookRepository,
    InMemoryAutomationWebhookSchemaRegistry, PostgresAutomationDefinitionRepository,
