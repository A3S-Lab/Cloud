...
pub use application::{
    ...
    ConnectorRevisionRevocationMutationResult, ConnectorsEnvironmentScope, CreateConnectorProfile,
...
pub use infrastructure::{
    ...
    ProjectsConnectorsEnvironmentAccessAdapter, PublicInternetConnectorEgressAuthorizer,
    ResolvedConnectorAuthentication, ResolvedConnectorHttpRevision,
    CONNECTOR_RESPONSE_OBJECT_NAMESPACE,
};
