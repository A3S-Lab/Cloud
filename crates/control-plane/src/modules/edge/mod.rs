...
pub use infrastructure::{
    ...
    PlanMcpGatewayProjectionSet, PlanMcpRouteProjection, PlannedMcpGatewayNodeProjection,
    PlannedMcpGatewayProjection, PlannedMcpGatewayProjectionSet, StageMcpGatewaySnapshot,
