...
pub use infrastructure::{
    ...
    McpGatewayProjectionPlanner, McpGatewayProjectionSetPlanner, McpGatewaySnapshotDispatchTarget,
    ...
    PlannedMcpGatewayProjectionSet, StageMcpGatewaySnapshot, VaultGatewayCertificateAuthority,
