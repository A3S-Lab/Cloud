...
pub use infrastructure::{
    ...
    McpGatewayNodeProjectionAssembler, McpGatewayProjectionAssembler, McpGatewayProjectionCompiler,
    McpGatewayProjectionPlanner, McpGatewayProjectionSetPlanner, McpGatewayReconciliationScope,
    McpGatewaySnapshotAnchor, McpGatewaySnapshotDispatchTarget, McpGatewaySnapshotInputs,
