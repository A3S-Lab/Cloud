...
pub use types::{
    ...
    KNOWLEDGE_DATASOURCE_ENTRANCE_SCHEMA_V1, KNOWLEDGE_INGESTION_PROVENANCE_SCHEMA_V1, KNOWLEDGE_PROCESSOR_OUTPUT_CONTRACT_SCHEMA_V1, KNOWLEDGE_SOURCE_TOMBSTONE_SCHEMA_V1,
