...
pub use application::{
    ...
    GetOutboundNotificationSubscriptionHandler, INotificationsEnvironmentAccess,
    INotificationsNodeAccess, IOutboundNotificationDispatcher, IOutboundRecipientContactAccess,
    ...
    MarkNotificationReadHandler, MarkNotificationReadResult, NotificationAccess,
    NotificationAccessScope, NotificationAlertPolicyMutationResult, NotificationsEnvironmentScope,
    NotificationsNodeScope, OutboundNotificationDispatchResult, OutboundNotificationDispatcher,
    OutboundNotificationSmtpDispatcher, OutboundNotificationSubscriptionMutationResult,
    OutboundVerifiedRecipientContact, RevokeNotificationAlertPolicy,
...
pub use infrastructure::{
    ...
    IdentityOutboundRecipientContactAccessAdapter, InMemoryNotificationRepository,
