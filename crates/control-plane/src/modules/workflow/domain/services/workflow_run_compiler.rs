...
use crate::modules::workflow::domain::{
    ...
    WORKFLOW_RUN_FLOW_VERSION_V22, WORKFLOW_RUN_FLOW_VERSION_V3, WORKFLOW_RUN_FLOW_VERSION_V4,
    ...
    WORKFLOW_RUN_INPUT_SCHEMA_V20, WORKFLOW_RUN_INPUT_SCHEMA_V21, WORKFLOW_RUN_INPUT_SCHEMA_V22,
    WORKFLOW_RUN_INPUT_SCHEMA_V3, WORKFLOW_RUN_INPUT_SCHEMA_V4, WORKFLOW_RUN_INPUT_SCHEMA_V7,
    ...
    fn compile_with_projection(
        ...
        let (
            ...
            (
                ...
                let (input_schema, runtime_revision, flow_version) = if has_parallel_iteration {
                    (
