...
use crate::modules::workflow::domain::{
    ...
    WorkflowApplicationFrameAuthority, WorkflowCompositeRegionPolicy, WorkflowGoal,
    WorkflowRevision, WorkflowRun, WorkflowRunApplicationProjection, WorkflowRunInput,
    WorkflowStepProjection, WORKFLOW_PLAN_SCHEMA, WORKFLOW_PLAN_SCHEMA_V10,
    ...
    WORKFLOW_RUN_INPUT_SCHEMA_V24, WORKFLOW_RUN_INPUT_SCHEMA_V3, WORKFLOW_RUN_INPUT_SCHEMA_V4,
    ...
    fn compile_with_projection(
        ...
        let (
            ...
            (
                ...
                let has_parallel_iteration = contracts.composite_regions().is_some_and(|regions| {
                ...
                let (input_schema, runtime_revision, flow_version) = if workflow_revision
                    .has_agent_step()
                {
                    (
                    ...
                    match plan_schema {
                        ...
                        WORKFLOW_PLAN_SCHEMA_V6 => {
                            return Err("Workflow Plan v6 requires Application composition".into())
                        }
                        WORKFLOW_PLAN_SCHEMA_V7 => {
                            return Err("Workflow Plan v7 requires Application composition".into())
                        }
