...
use crate::modules::workflow::domain::{
    ...
    WORKFLOW_PLAN_SCHEMA_V9, WORKFLOW_RUN_FLOW_NAME, WORKFLOW_RUN_FLOW_VERSION,
    ...
    fn compile_with_projection(
        ...
        let (
            ...
            (
                ...
                let (input_schema, runtime_revision, flow_version) = if plan_schema
                    == WORKFLOW_PLAN_SCHEMA_V12
                {
                    (
                ...
                } else if workflow_revision.has_agent_step() {
                    (
