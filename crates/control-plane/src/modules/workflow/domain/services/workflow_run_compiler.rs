...
use crate::modules::workflow::domain::{
    ...
    WORKFLOW_PLAN_SCHEMA, WORKFLOW_PLAN_SCHEMA_V10, WORKFLOW_PLAN_SCHEMA_V11,
    ...
    WORKFLOW_RUN_FLOW_VERSION_V20, WORKFLOW_RUN_FLOW_VERSION_V21, WORKFLOW_RUN_FLOW_VERSION_V3,
        ...
        let (
            ...
            (
                ...
                let (input_schema, runtime_revision, flow_version) = if workflow_revision
                    .has_list_operator_configuration()
                {
                    (
