...
pub use application::{
    ...
    IWorkloadsEnvironmentAccess, ListWorkloads, ListWorkloadsHandler,
...
pub use infrastructure::{
    ...
    ProjectsWorkloadsEnvironmentAccessAdapter, ReplicaDeploymentMaterializationFailure,
    ReplicaDeploymentMaterializationReport, ReplicaDeploymentMaterializer,
