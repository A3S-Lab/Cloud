...
pub use domain::entities::{
    ...
    ServicePort, ServiceProcess, ServiceResources, ServiceTemplate, SkillReleaseAdmission,
    SkillWorkloadRevisionBinding, SourceBuildAdmission, Workload, WorkloadControl,
    WorkloadControlSpec, WorkloadDesiredState, WorkloadPlacementGroup,
