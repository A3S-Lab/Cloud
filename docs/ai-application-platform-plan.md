...
| `AUT0.2` | In progress; component-only admission boundary exists, while signed endpoint delivery, schema evaluation, replay/recovery, lifecycle APIs, and Gateway recovery remain to be composed | `AUT0.1`, `E0`, `C0.3` |
