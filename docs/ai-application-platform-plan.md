...
| `AUT0.2` | In progress; component-only admission, PostgreSQL, and exact-version signature boundary exists, while signed transport, schema evaluation, public lifecycle APIs, and Gateway recovery remain to be composed | `AUT0.1`, `E0`, `C0.3` |
