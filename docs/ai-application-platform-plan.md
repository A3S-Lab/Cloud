...
| `AUT0.3` | In progress; component-only calendar, misfire, concurrency, due-window, and lease boundaries exist, while catch-up rules, durable cursor/lease persistence, and P0 scheduled Task adaptation remain open | `AUT0.1`, Boot compatibility lock, P0 profile contract |
