...
| `AUT0.2` | In progress; component-only admission and PostgreSQL recovery boundary exists, while signed transport, schema evaluation, public lifecycle APIs, and Gateway recovery remain to be composed | `AUT0.1`, `E0`, `C0.3` |
