...
| `K0.1-C4b` | Expose Knowledge/KnowledgePipeline lifecycle through authorization, idempotency, audit, Outbox, REST/OpenAPI, maintained client, CLI, and applicable Management MCP authority over the C4a catalogs. Search remains a rebuildable projection and pipeline execution remains unavailable until later K0 gates. | `K0.1-C2`, `K0.1-C4a`, `C0.1` |
