...
| `K0.1-C4b2b` | Expose Knowledge/KnowledgePipeline lifecycle through REST/OpenAPI, maintained client, CLI, and applicable Management MCP authority over the C4b2a mutation boundary. Search remains a rebuildable projection and pipeline execution remains unavailable until later K0 gates. | `K0.1-C2`, `K0.1-C4b2a`, `C0.1` |
