...
implementation is not a public capability. The forty authority decisions are
...
2. **Finish the W0 semantic foundation.** Retain protected WorkflowRun and
   ...
   `APP0.2-C1/C2/C3/C4/C5/C6/C7/C8/C9/C10` Applications-owned variable, Answer,
   ...
   final-output/terminal reconciliation, and v11 descriptor-bound Answer
   dispatch, then complete Application-variable dispatch and remaining non-Execution error branches,
...
3. **Land the three owning contracts.** Retain the implemented `APP0.1`
   ...
   `APP0.2-C8` management adapter, and component-only `APP0.2-C9/C10`, and implement
   `K0.1` and
