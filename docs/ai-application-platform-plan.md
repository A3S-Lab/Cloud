...
| `AUT0.3` | In progress; component-only calendar and misfire boundaries exist, while catch-up/concurrency rules, lease-safe due evaluation, and P0 scheduled Task adaptation remain open | `AUT0.1`, Boot compatibility lock, P0 profile contract |
