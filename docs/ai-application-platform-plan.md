...
| `AUT0.3` | In progress; component-only calendar, misfire, and concurrency boundaries exist, while catch-up rules, lease-safe due evaluation, and P0 scheduled Task adaptation remain open | `AUT0.1`, Boot compatibility lock, P0 profile contract |
