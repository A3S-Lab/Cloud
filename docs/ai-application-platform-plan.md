...
| `AUT0.2` | In progress; component-only admission, PostgreSQL, exact-version signature, and digest-bound schema-evaluation boundaries exist, while signed transport, registry selection, public lifecycle APIs, and Gateway recovery remain to be composed | `AUT0.1`, `E0`, `C0.3` |
