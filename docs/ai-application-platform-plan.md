...
| `AUT0.3` | In progress; component-only calendar, misfire, concurrency, due-window, lease, durable cursor/lease, exact invocation-envelope, and bounded schedule-dispatch boundaries exist, while catch-up rules, timer ownership, and P0 scheduled Task adaptation remain open | `AUT0.1`, Boot compatibility lock, P0 profile contract |
