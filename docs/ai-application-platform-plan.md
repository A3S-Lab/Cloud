...
| `AUT0.2` | In progress; component-only admission, PostgreSQL, exact-version signature, digest-bound evaluation, and exact-digest registry-selection boundaries exist, while signed transport, production registry wiring, public lifecycle APIs, and Gateway recovery remain to be composed | `AUT0.1`, `E0`, `C0.3` |
