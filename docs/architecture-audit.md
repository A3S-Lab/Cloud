...
Workloads/Executions adapters and production composition remain named follow-up
work; the separate C5a Projects Environment adapter is production-composed but
does not imply build, deployment, route, cleanup, or interface availability.
