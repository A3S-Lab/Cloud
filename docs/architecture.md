...
| Edge | Domains, certificates, logical Gateway scopes, routes, snapshots, applied projection, and bounded typed certificate-renewal terminal facts | Current; `C0.3-N4b` schema-v1 renewal failure/recovery facts per logical Route and physical Gateway node are verified over the existing certificate reconciler and transactional Outbox by the [PostgreSQL 17.5 H0 gate](https://github.com/A3S-Lab/Cloud/actions/runs/32543351641/job/96957381856) |
