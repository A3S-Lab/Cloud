...
execution is dispatched. Production model and Tool binding producers, any
additional independent MCP binding, retained PostgreSQL/real-provider recovery
and audit evidence, and provider/Box private checkpoint certification remain
open.
