...
New Operation histories also pin runtime build `a3s-cloud-workflows@22` and
...
existing `step_created` events, and runtime builds `@1`-`@21` remain explicit
...
v19 adds only descriptor-bound composite-region failure selection, and v20
adds exact typed Variable Aggregation while preserving every admitted v2-v19
semantic. A step
