...
| Artifacts | Immutable admitted bytes, receipts, evidence, and retention | Current; Domain consumes Sources only through published language, external staging crosses an Application port, and hosted Asset staging plus public Infrastructure remain migration debt |
