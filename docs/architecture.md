...
New Operation histories also pin runtime build `a3s-cloud-workflows@21` and
...
existing `step_created` events, and runtime builds `@1`-`@20` remain explicit
...
v19 adds only descriptor-bound composite-region failure selection. A step
