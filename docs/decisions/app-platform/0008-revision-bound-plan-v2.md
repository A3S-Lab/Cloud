...
Flow workflow version 1. Plan v2 normally uses WorkflowRun input/runtime/Flow
version 2. Composite-region Plan v2 runs use version 3 under decisions 0012
and 0018; the immutable run input carries the exact canonical variable contract, and the
...
Decisions 0016 through 0018 implement composite-local scopes, exports, ordered
reduction, and authority-bound child WorkflowRun execution. Applications-owned
reads/writes still fail closed until their owning adapter exists.
