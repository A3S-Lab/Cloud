...
- `C0.5-MT1-C1` is component-only. `TenantSupportGrant`, effective-decision and
  audit ACLs, installation-scoped Outbox/audit persistence, repositories,
  authorization interfaces, migration of boolean administrator bypasses and
  adversarial multi-replica evidence remain required.
