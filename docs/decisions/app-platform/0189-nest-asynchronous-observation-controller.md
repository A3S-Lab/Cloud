# 0189. Nest-macro asynchronous observation query controller
...
surfaces. `application_asynchronous_observation_queries_controller` is a scoped Applications poll GET.
