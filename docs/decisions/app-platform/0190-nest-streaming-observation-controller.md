# 0190. Nest-macro streaming observation query controller
...
surfaces. `application_streaming_observation_queries_controller` is a scoped Applications poll GET with optional `afterSequence`.
