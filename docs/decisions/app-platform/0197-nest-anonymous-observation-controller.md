# 0197. Nest-macro anonymous delivery observation controller
...
surfaces. `anonymous_application_observation_queries_controller` is a public `/anonymous-delivery` poll GET surface.
