...
1. retain the frozen versioned ACL parity manifest, its exact digest-bound
   ...
   and closed, bounded finite-Execution/Connector evidence correlations
   reconstructed from verified Flow history without another evidence store,
