...
slices must add node bootstrap, authorized global search, REST
compatibility/deprecation policy, and real cross-surface automation evidence
through the same typed client and application commands or queries.
