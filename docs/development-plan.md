...
- `CELL0.5` is the first availability gate. Component-only C1 implements S0's
  ...
  historic v1-v3 replays keep their old step graphs. C4/C5 then make one real
