...
- `CELL0.4-C2` adds authorized idempotent application commands and bounded
  queries. `C3` persists only the planned deployment correlation and composes
