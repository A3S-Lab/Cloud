...
- Implemented as the first backend-only `C0.3` slice: one stable human or
  ...
  plus browser-safe link start. `C0.3` remains in progress because retained
  OIDC PostgreSQL cross-surface evidence, attribution, notifications, security
