...
slices must add remaining edge, source, Secret, and identity mutations plus
...
and real cross-surface automation evidence. Desired-state files remain A3S
ACL; the CLI must not add JSON or TOML configuration. No CLI command may read
