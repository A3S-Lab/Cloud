...
Outbox, and audit paths. Focused domain/application/coordinator/REST/MCP/client/
CLI tests pass; the retained real PostgreSQL provider gate must run before this
slice is verified. Business-service and remaining provider capability
