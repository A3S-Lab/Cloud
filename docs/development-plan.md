...
- Implemented locally as component-only `AUT0.5-C3`: create, revise, current,
...
- Production egress/SSRF policy, execution evidence, internal execution
  authorization, revocation/recovery, Workflow ports, supported management
  surfaces, and provider wiring remain open in `AUT0.5`; these components create
