...
2. retain protected `W0.3` runs, reachable-sink Output aggregation, the
   ...
   deterministic component-only frame/export reducer; complete Flow-backed
   Iteration/Loop dispatch, deterministic region ordering, Answer frames, typed
