...
- The REST contract boundary serves committed `openapi/v1.json` as raw public
  ...
  and every API response pin the current contract `1.20.0`. Focused tests regenerate the
...
pair, and monotonic aggregate version at every boundary. REST `1.20.0`, the
