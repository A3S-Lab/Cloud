...
- `CELL0.4-C4` adds one authorization-before-replay internal composition
  ...
  they add no parser, OCI/DNS authority, or state. Web stays deferred. `C6`
  retains PostgreSQL replay/process-death evidence before the orchestration
  gate can be treated as complete.
