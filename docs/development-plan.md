...
- Cloud pins native `a3s-form-core` `0.1.0` at exact revision
  ...
  Cloud copy.
- New Operation histories pin runtime build `a3s-cloud-workflows@10`. The
  former `@1` through `@9` generations are explicit replay-compatible migration entries;
...
- Implemented as the component-only Workflow Connector Flow slice
  ...
  byte-compatible. Current replay build `a3s-cloud-workflows@10` keeps
  versions/builds `@1` through `@9` explicitly replayable. Migration `123`
...
3. retain the implemented `APP0.1`, component-only
   ...
   adapter, and component-only `APP0.2-C9`,
