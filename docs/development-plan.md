...
slices must add identity parity through the same typed client, followed by node
bootstrap, authorized global search, REST compatibility/deprecation policy,
and real cross-surface automation evidence.
