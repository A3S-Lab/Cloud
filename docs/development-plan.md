...
The current REST/OpenAPI contract is `1.42.0`. It adds project-authorized
Application create/publish/list/current/exact-history management over the
immutable `APP0.1` authority. It retains `1.41.0`'s optional exact Plan v3/v5
...
- Implemented as the operational-mutation `C0.2` slice: Workload stop and
  ...
  tests prove the current 117-tool administrator and 68-tool read-only catalogs,
...
1. retain the frozen versioned ACL parity manifest, its exact digest-bound
   23-node profile contract, thirty-seven accepted authority decisions, the immutable
...
3. retain the implemented `APP0.1` and component-only `APP0.2-C1/C2/C3/C4/C5/C6/C7` authorities,
