...
- `CELL0.4-C4` adds one authorization-before-replay internal composition
  ...
  [retained C6a PostgreSQL 17 gate](https://github.com/A3S-Lab/Cloud/actions/runs/31935793202/job/95137381473)
  ...
  through fresh production repositories. Stop/restart and cleanup fault
  evidence still blocks completion of the orchestration gate.
