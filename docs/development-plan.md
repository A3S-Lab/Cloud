...
3. retain the implemented `APP0.1` authority and land `K0.1` and `AUT0.1` as
   independent contract/persistence/API slices with no temporary provider clients;
