...
revisions, runs enroll/OCI/deploy steps 1–3 preflight only (`enroll=not_run`,
`oci=not_run`, `deploy=not_run`), leaves steps 4–9 OPEN, and leaves Power
...
(including stub pin missing/mismatch/match and enroll/OCI/deploy preflight) and
