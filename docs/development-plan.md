...
1. retain the frozen versioned ACL parity manifest, its exact digest-bound
   23-node profile contract, thirty-one accepted authority decisions, the immutable
...
3. retain the implemented `APP0.1` and component-only `APP0.2-C1` authorities,
