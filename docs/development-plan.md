...
- Implemented as the first backend-only `C0.3` slice: one stable human or
  ...
  verified, later cross-layer security investigation, product usage-fact
  profile snapshots, complete multi-page export, and SIEM delivery remain open.
