...
revisions, runs enroll step-1 preflight only (`enroll=not_run`), leaves steps
2–9 OPEN, and leaves Power `UNBOUND` until PW0; product `EXIT` remains open and
...
(including stub pin missing/mismatch/match and enroll preflight) and may emit
