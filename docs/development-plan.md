...
commands and queries; additional curated operations and real PostgreSQL MCP
evidence remain.
...
- Implemented as the first `C0.2` slice: a stateless Streamable HTTP management
  ...
  carry the same success or business-error envelope as REST. Broader curated
  operational coverage and the real PostgreSQL conformance gate remain.
