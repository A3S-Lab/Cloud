...
create/list/get/revoke lifecycle without another endpoint or policy type. It
...
- The REST contract boundary serves committed `openapi/v1.json` as raw public
  ...
  and every API response pin the current contract `1.51.0`. Focused tests
