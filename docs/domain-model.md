...
writer-fence receipt and durable recovery-enqueue path, and retained
real-provider fault evidence remain planned. This boundary prevents stateful behavior from
