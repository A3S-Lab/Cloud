...
**Status as of 2026-08-16: `CELL0.1-C1` through `CELL0.1-C3`, component-only `CELL0.2-C1/C2`, `CELL0.3-C1/C2`, and `CELL0.4-C1/C2/C3/C4/C5` are implemented; the `CELL0.2-C3` storage gate, `CELL0.3-C3` runtime-only provider gate, and `CELL0.4-C1/C2/C3` PostgreSQL gate are checked in but have no retained passes; the product is unavailable.**
...
retained PostgreSQL/provider runs and all of `C6` remain.
