...
deployment behavior without creating a publication Execution. It does not
itself certify a real S0 publication; that retained evidence remains part of
the open C3 gate.
