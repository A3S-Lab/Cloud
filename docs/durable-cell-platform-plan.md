...
**Status as of 2026-08-16: `CELL0.1-C1` through `CELL0.1-C3`, component-only `CELL0.2-C1/C2`, `CELL0.3-C1/C2`, and `CELL0.4-C1/C2/C3/C4/C5` are implemented; the [`CELL0.4-C1/C2/C3` PostgreSQL 17 gate](https://github.com/A3S-Lab/Cloud/actions/runs/31934571002/job/95134413816) has a retained pass, while the `CELL0.2-C3` storage gate and `CELL0.3-C3` runtime-only provider gate have none; the product is unavailable.**
...
[retained PostgreSQL 17 H0 gate](https://github.com/A3S-Lab/Cloud/actions/runs/31934571002/job/95134413816)
passes this C1-C3 fixture. Retained provider runs and all remaining `C6` fault
evidence remain.
