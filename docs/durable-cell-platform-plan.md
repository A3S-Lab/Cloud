...
Component-only `C1/C2/C3/C4` are implemented. Their shared PostgreSQL fixture verifies
...
target resolution or dispatch. A retained run plus `C5` and `C6` remain.
