...
comment on constraint workflow_step_projections_selected_handle_routing_check
    ...
    'A non-Branch handle records only a failed descriptor-bound Execution, Connector, Application variable, or Application Answer route; the immutable WorkflowRun plan validates the exact handle and descriptor';
