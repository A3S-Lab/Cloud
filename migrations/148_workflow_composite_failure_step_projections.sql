...
comment on constraint workflow_step_projections_selected_handle_routing_check
    ...
    'A non-Branch handle records only a failed descriptor-bound Transform, Execution, Connector, Application, Output, or composite-region route; the immutable WorkflowRun plan validates the exact handle and descriptor';
