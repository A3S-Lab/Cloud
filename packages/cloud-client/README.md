...
sole authorization, audit, replay, and PostgreSQL transaction authority.
...
Contract `1.65.0` added exact Connector revision revocation reads and writes
plus closed operation-specific Connector schemas; `1.64.0` already closed every
Workflow result type, including Ontology
...
Plan v7 Application-Answer, Plan v8 Workflow-local Transform, and Plan v9
Workflow-local Output failure semantics plus
`cloud.workflow.step-failure.v2` through v6. These runtime
