...
5) Arm gate preflight, then execute steps 1–5 with real receipts (still not EXIT):
  ...
  # expected while steps 6–9 unexecuted: exit 3 OPEN with enroll/oci/deploy/health/https executed
