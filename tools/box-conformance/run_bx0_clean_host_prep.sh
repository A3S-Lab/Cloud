...
5) Arm gate preflight, then execute steps 1–4 with real receipts (still not EXIT):
  ...
  # expected while steps 5–9 unexecuted: exit 3 OPEN with enroll/oci/deploy/health executed
