...
const ZH_CN: Record<string, string> = {
  ...
  'One control path from A3S OS intent to the sole A3S Code Harness. Every exported image is rendered from the HTML below.':
    '从 A3S OS 意图到唯一 A3S Code Harness 的统一控制路径。所有导出图片均由下方 HTML 实时渲染。',
  'Export PNG': '导出 PNG',
  'Exporting...': '正在导出...',
  ...
  'A3S Code Core / Sole Agent execution Harness': 'A3S Code Core / 唯一 Agent 执行 Harness',
  'A3S OS only orchestrates and transports': 'A3S OS 仅负责编排与传输',
  ...
  'The complete 17-gate portfolio shares one control path from A3S OS intent to Runtime, Gateway, and the sole A3S Code Harness.':
    '完整的 17 个产品 Gate 共用一条从 A3S OS 意图到 Runtime、Gateway 与唯一 A3S Code Harness 的控制路径。',
